    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {  
        ...
        if (null != tempRoleList) {  
            for (SRole role : tempRoleList) {  
                authoritiesBuilder.append(",").append(role.getEnname());  
            }  
        }  
        ...
        if (null != tempPermissionList) {  
            for (SPermission permission : tempPermissionList) {  
                authoritiesBuilder.append(",").append(permission.getEnname());  
            }  
        }  
        ...
        logger.info("VUserDetails getAuthorities(用户权限列表) [authoritiesStr={} ", authoritiesStr);  
